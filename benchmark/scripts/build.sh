...
wanco --enable-cr --disable-loop-cr ${LLAMA2_DIR}/llama2-c.wasm -o "llama2-c-no-loop"
...
wanco --enable-cr --disable-loop-cr ${LABBENCH_DIR}/nbody.c.wasm -o "nbody-no-loop"
...
wanco --enable-cr --disable-loop-cr ${LABBENCH_DIR}/binary-trees.c.wasm -o "binary-trees-no-loop"
