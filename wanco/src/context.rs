...
use inkwell::{
    ...
    debug_info::{DICompileUnit, DILexicalBlock, DISubprogram, DebugInfoBuilder},
    module::Module,
...
pub struct Context<'a, 'b> {
    ...
    pub current_fn_lexical_scope: Option<DILexicalBlock<'a>>,
