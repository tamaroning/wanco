...
static Stackmap::Header
parse_header (const uint8_t *&ptr)
{
...
static Stackmap::StkSizeRecord
parse_stk_size_record (const uint8_t *&ptr)
{
...
static Stackmap::Constant
parse_constant (const uint8_t *&ptr)
{
...
static Stackmap::Location
parse_location (const uint8_t *&ptr)
{
...
static Stackmap::LiveOut
parse_live_out (const uint8_t *&ptr)
{
...
static Stackmap::StkMapRecord
parse_stk_map_record (const uint8_t *&ptr)
{
...
static std::string
location_kind_to_string (Stackmap::LocationKind kind)
{
  switch (kind)
    {
