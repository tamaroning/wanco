...
static wanco::Value
decode_value_proto (const chkpt::Value &v)
{
  switch (v.type ())
    {
      case chkpt::Type::I32: {
...
static wanco::Frame
decode_frame_proto (const chkpt::Frame &f)
{
  wanco::Frame frame;
...
static chkpt::Value
encode_value_proto (const wanco::Value &v)
{
  chkpt::Value ret;
  switch (v.get_type ())
    {
...
static chkpt::Frame
encode_frame_proto (const wanco::Frame &f)
{
  chkpt::Frame ret;
...
void
encode_checkpoint_proto (std::ofstream &ofs, Checkpoint &chkpt)
{
  chkpt::Checkpoint buf;
